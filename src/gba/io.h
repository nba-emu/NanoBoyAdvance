...
const int SOUND1CNT_H = 0x62;
const int SOUND1CNT_X = 0x64;
const int SOUND2CNT_L = 0x68;
const int SOUND2CNT_H = 0x6C;
const int SOUND3CNT_L = 0x70;
const int SOUND3CNT_H = 0x72;
const int SOUND3CNT_X = 0x74;
const int SOUND4CNT_L = 0x78;
const int SOUND4CNT_H = 0x7C;
