...
#include "device/shader/color_higan.glsl.hh"
#include "device/shader/color_agb.glsl.hh"
#include "device/shader/lcd_ghosting.glsl.hh"
#include "device/shader/lcd1x.glsl.hh"
#include "device/shader/output.glsl.hh"
#include "device/shader/sharp_bilinear.glsl.hh"
#include "device/shader/xbrz.glsl.hh"
