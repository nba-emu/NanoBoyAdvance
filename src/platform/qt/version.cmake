...
if(GIT_FOUND)
  execute_process(COMMAND ${GIT_EXECUTABLE} rev-parse --abbrev-ref HEAD OUTPUT_VARIABLE VERSION_GIT_BRANCH)
  execute_process(COMMAND ${GIT_EXECUTABLE} describe --match=nevermatch --always --dirty OUTPUT_VARIABLE VERSION_GIT_HASH)
